// Originally in here: https://github.com/Ciantic/trayicon-rs/blob/master/src/menubuilder.rs
use crate::Error;
use crate::Icon;
    ...
    T: PartialEq + Clone + 'static,
{
    ...
    pub(crate) fn build(&self) -> Result<(), Error> {
...
pub(crate) mod tests {
    ...
    fn test_menu_mutation() {
        // This is a good way to create menu conditionally on application state, define
        // a function "State -> Menu"
